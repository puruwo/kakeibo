            ...
            builder: ((context, snapshot) {
              ...
              return InkWell(
                  ...
                  child: displayDate == DateTime(year, month, day)
                      ? activeDateBox(weekday, label, priceLabel, boxHeight,boxWidth)
                      : isTapable
                          ? normalDateBox(weekday, label, priceLabel, boxHeight,boxWidth)
...
Container normalDateBox(
    int weekday, String dateLabel, Text priceLabel, double boxHeight,double boxWidth) {
  return Container(
    width: boxWidth,
    height: boxHeight,
    decoration: const BoxDecoration(
